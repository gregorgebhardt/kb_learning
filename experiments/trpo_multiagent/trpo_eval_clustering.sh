...
mpiexec -map-by core -bind-to core python trpo_multiagent/trpo_ma.py trpo_multiagent/trpo_ma_clustering.yml \
    -m -e eval_object_sorting2 -g 1 -l DEBUG -j $SLURM_ARRAY_TASK_ID

...
#SBATCH -J trpo_ma_eval_object_net_size
...
mpiexec -np 121 -map-by node -bind-to hwthread python trpo_multiagent/trpo_ma.py trpo_multiagent/trpo_ma.yml -me eval_object_net_size -g 12 -l DEBUG

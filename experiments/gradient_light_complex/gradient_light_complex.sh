...
job_stream --hostfile $SLURM_JOB_ID.hostfile.converted -- python gradient_light_complex/gradient_light_complex.py -c gradient_light_complex/gradient_light_complex.yml --log_level INFO

...
job_stream --hostfile $SLURM_JOB_ID.hostfile.converted -- python fixed_weight_quad/fixed_weight_quad.py -c fixed_weight_quad/fixed_weight_quad.yml -e discount_factor --log_level INFO

...
from kb_learning.tools.trpo_tools import traj_segment_generator, add_vtarg_and_adv, flatten_lists, ActWrapper
...
class TRPOMultiAgentLearner(ClusterWork):
    ...
    def reset(self, config: dict, rep: int):
        # TODO chose these parameters according to parameters
